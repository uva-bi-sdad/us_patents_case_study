...
write.csv(civil_male_sample,"genderized_outputs/civil_male_large_gendered1.csv", row.names = FALSE)
write.csv(civil_nonmale_sample,"genderized_outputs/civil_nonmale_large_gendered1.csv", row.names = FALSE)
write.csv(pharma_male_sample,"genderized_outputs/pharma_male_large_gendered1.csv", row.names = FALSE)
write.csv(pharma_nonmale_sample,"genderized_outputs/pharma_nonmale_large_gendered1.csv", row.names = FALSE)
